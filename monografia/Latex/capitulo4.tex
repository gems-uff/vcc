...
Diversas estratégias foram analisadas, com o intuito de decidir como as chamadas de método que já foram codificadas seriam enviadas para serem consultadas na árvore de padrões frequentes. Duas opções principais foram identificadas e são expostas a seguir. 
